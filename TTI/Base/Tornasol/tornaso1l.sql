...
CREATE TABLE IF NOT EXISTS `tornasol`.`estacion` (
  ...
  UNIQUE INDEX `id_estacion_UNIQUE` (`id_estacion` ) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tornasol`.`mecanismo` (
  ...
  UNIQUE INDEX `id_mecanismo_UNIQUE` (`id_mecanismo` ) ,
...
CREATE TABLE IF NOT EXISTS `tornasol`.`mes` (
  ...
  INDEX `fk_mes_estacion1_idx` (`id_estacion` ) ,
...
CREATE TABLE IF NOT EXISTS `tornasol`.`ubicacion` (
  ...
  UNIQUE INDEX `id_ubicacion_UNIQUE` (`id_ubicacion` ) ,
  INDEX `fk_ubicacion_mes1_idx` (`id_mes` , `id_estacion` ) ,
...
CREATE TABLE IF NOT EXISTS `tornasol`.`bateria` (
  ...
  INDEX `fk_bateria_mecanismo1_idx` (`id_mecanismo` ) ,
...
CREATE TABLE IF NOT EXISTS `tornasol`.`panel solar` (
  ...
  INDEX `fk_panel solar_mecanismo1_idx` (`id_mecanismo` ) ,
...
CREATE TABLE IF NOT EXISTS `tornasol`.`historial_bateria_panel` (
  ...
  INDEX `fk_descarga_bateria_bateria1_idx` (`id_bateria` ) ,
  INDEX `fk_historial_bateria_panel_panel solar1_idx` (`id_panel` ) ,
...
CREATE TABLE IF NOT EXISTS `tornasol`.`sensadoP` (
  ...
  INDEX `fk_sensadoP_panel solar1_idx` (`id_panel` ) ,
...
CREATE TABLE IF NOT EXISTS `tornasol`.`sensadoB` (
  ...
  INDEX `fk_sensadoB_bateria1_idx` (`id_bateria` ) ,
...
CREATE TABLE IF NOT EXISTS `tornasol`.`fase_bateria` (
  ...
  INDEX `fk_fase_bateria_estado_fase1_idx` (`id_estado_fase` ) ,
...
CREATE TABLE IF NOT EXISTS `tornasol`.`bateria_fase_bateria` (
  ...
  INDEX `fk_bateria_has_fase_bateria_fase_bateria1_idx` (`id_fase_bateria` ) ,
  INDEX `fk_bateria_has_fase_bateria_bateria1_idx` (`id_bateria` ) ,
