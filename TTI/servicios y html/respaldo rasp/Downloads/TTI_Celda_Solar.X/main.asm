...
;------------------------------------------------------------
	...
	movwf	RxUSART
	xorlw	0xe1			;¿Se recibio el "Comando" de Petición? En este lado la Rasbperry manda un msn de estar lista
	btfsc	status,z
	goto	Tx_Protocolo
...
Tx_Protocolo
	...
	movf	VoltAlto		;Se transmite el valor de Voltaje
	movwf	TxUSART
	call	transmite
	call	temp10micros
	movf	VoltBajo
	...
	movf	CorrienteAlto		;Se transmite el valor de Corriente
	movwf	TxUSART
	call	transmite
	call	temp10micros
	movf	CorrienteBajo
	...
	movf	NumeroEntero			;Ventiladoralto		;Se transmite el valor de Temperatura
	movwf	TxUSART
	call	transmite
	call	temp10micros
	movf	NumeroFraccionCen		;Ventiladorbajo
	movwf	TxUSART
	call	transmite
	call	temp10micros
