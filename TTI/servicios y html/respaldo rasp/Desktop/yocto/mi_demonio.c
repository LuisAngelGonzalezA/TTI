...
// Se realiza un segundo fork para separarnos completamente de la sesion del padre
    ...
    if( pid )
    {
        ...
        /*recordar donde vas a guardar el demonio a aejecutar en un principio esta en la carpeta de 
        de /run/ a lo cual se debía de leer en esta ruta pero ahora lo estamos generando en la raíz 
        del usuario para obtener el pid del proceso de la ejecución
        */
